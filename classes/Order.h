#ifndef LAURENT_FINAL_PROJECT_ORDER_H
#define LAURENT_FINAL_PROJECT_ORDER_H

#include <string.h>
enum ordertype {LIMIT, MARKET, ADMENDMENT};
...
#endif //LAURENT_FINAL_PROJECT_ORDER_H